...
description: 为Agent提供智能记忆管理能力，包括重要性评分、遗忘机制、意图检索等功能
metadata:
  openclaw:
    emoji: 🧠
    aiFriendly: true
    ...
    requires:
      minimal: true
      packages: ['python>=3.8', 'sqlite3', 'numpy', 'scikit-learn']
    category: agent-management
    tags: ['memory', 'agent', 'context-management', 'importance-scoring', 'retrieval']
version: 1.0.0
---
...
### 3.2 使用示例
```python
from memory_enhancer import SkillAPI
